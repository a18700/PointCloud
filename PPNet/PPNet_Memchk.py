...
class GTResNet(nn.Module):
    ...
    def forward(self, end_points):
        ...
        cnt=0
        tic=time.time()
        cnt, tic = memchk(cnt, level=0, tic=tic, string="Start")
        ...
        #MEMCHK# 0
        tic = time.time()
        cnt, tic = memchk(cnt, level=0, tic=tic, string="Res1 End")
        #MEMCHK#
        ...
        #MEMCHK# 0
        tic = time.time()
        cnt, tic = memchk(cnt, level=0, tic=tic, string="Res2 End")
        #MEMCHK#
        ...
        print("Res5")
        print(end_points['neigh_idx'][4].shape)
...
class GTBottleneck(nn.Module):
    ...
    def forward(self, xyz, mask, features, attention_centrality=None, idx_knn=None):
        ...
        if self.downsample:
            ...
            cnt = 0
            tic = time.time()
            cnt, tic = memchk(cnt, level=4, tic=tic, string="GTBottleneck Start")
            #MEMCHK#
            sub_xyz, sub_mask, sub_features = self.maxpool(xyz, mask, features)
            query_xyz = sub_xyz
            query_mask = sub_mask
            ...
            #MEMCHK# 0
            tic = time.time()
            cnt, tic = memchk(cnt, level=4, tic=tic, string="Downsample End")
            #MEMCHK#
            ...
            #MEMCHK# 0
            tic = time.time()
            cnt, tic = memchk(cnt, level=4, tic=tic, string="Conv(Q,V) End")
            #MEMCHK#
        ...
        #MEMCHK# 0
        tic = time.time()
        cnt, tic = memchk(cnt, level=4, tic=tic, string="Aggregation End")
        #MEMCHK#

        output = self.conv2(output)
        #MEMCHK# 0
        tic = time.time()
        cnt, tic = memchk(cnt, level=4, tic=tic, string="Conv2 End")
        #MEMCHK#
...
class GTLModuleV1(nn.Module):
    ...
    def forward(self, query_xyz, support_xyz, query_mask, support_mask, queryandkey, value, attention_centrality=None, idx_knn=None):
        ...
        cnt = 0
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="GTLM Start")
        #MEMCHK#
        ...
        #MEMCHK#
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="View End")
        #MEMCHK#
        ...
        #MEMCHK#
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="LocalKey Gathering End")
        #MEMCHK#
        ...
        #MEMCHK#
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="LocalValue Gathering End")
        #MEMCHK#
        ...
        #MEMCHK#
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="LocalAtt Softmax End")
        #MEMCHK#
        ...
        #MEMCHK#
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="Attention Centrality End")
        #MEMCHK#
        ...
        #MEMCHK#
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="Feature Summarization End")
        #MEMCHK#
    ...
    def gather_neighbour(self, pc, neighbor_idx):  # pc: batch*npoint*channel
        ...
        cnt=0
        tic = time.time()
        cnt, tic = memchk(cnt, level=16, tic=tic, string="Gathering Start")
        #MEMCHK#
        ...
        #MEMCHK#
        tic = time.time()
        cnt, tic = memchk(cnt, level=16, tic=tic, string="Gathering End")
        #MEMCHK#
    ...
    def batch_gather_neighbour(self, pc, neighbor_idx):  
        ...
        cnt = 0
        tic = time.time()
        cnt, tic = memchk(cnt, level=12, tic=tic, string="Batch Gather Neighbour Start")
        #MEMCHK#
        ...
        for g in range(groups):
            ...
            #MEMCHK#
            tic = time.time()
            cnt, tic = memchk(cnt, level=12, tic=tic, string="Group {} End".format(g))
            #MEMCHK#
...
class MaskedMaxPool(nn.Module):
    ...
    def forward(self, xyz, mask, features):
        ...
        cnt=0
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="Before grid sampling")
        #MEMCHK#
        ...
        #MEMCHK# 0
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="After grid sampling & Before ball query")
        #MEMCHK#
        ...
        #MEMCHK# 0
        tic = time.time()
        cnt, tic = memchk(cnt, level=8, tic=tic, string="After ball query")
        #MEMCHK#
